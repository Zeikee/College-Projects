...
<body>
    ...
    <div class="container">
        <a href="facilitiesDashboard.php" class="back-link">Back to Dashboard</a>
        <h1>Facilities</h1>
        <div class="controls">
            <input type="text" id="searchInput" onkeyup="searchEquipment()" placeholder="Search for facilities...">
