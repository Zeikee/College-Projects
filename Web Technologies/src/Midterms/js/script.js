        ...
        roomElement.addEventListener('change', function() {
            ...
            if (selectedValue) {
                switch (selectedValue) {
                    case "1":
                        imageElement.src = "images/room528.png";
                        labelElement.textContent = "Room D528 Laboratory";
                        break;
                    case "2":
                        imageElement.src = "images/room427.png";
                        labelElement.textContent = "Room D427 Laboratory";
                        break;
                    case "3":
                        imageElement.src = "images/room223.png";
                        labelElement.textContent = "Room D223 Laboratory";
                        break;
                    case "4":
                        imageElement.src = "images/room422.png";
                        labelElement.textContent = "Room D422 Laboratory";
                        break;
                    case "5":
                        imageElement.src = "images/room424.png";
                        labelElement.textContent = "Room D424 Laboratory";
                        break;
                    case "6":
                        imageElement.src = "images/room425.png";
                        labelElement.textContent = "Room D425 Laboratory";
                        break;
                    case "7":
                        imageElement.src = "images/room522.png";
                        labelElement.textContent = "Room D522 Laboratory";
                        break;
                    case "8":
                        imageElement.src = "images/room524.png";
                        labelElement.textContent = "Room D524 Laboratory";
                        break;
                    case "9":
                        imageElement.src = "images/room526.png";
                        labelElement.textContent = "Room D526 Laboratory";
                        break;
                    case "10":
                        imageElement.src = "images/room722.png";
                        labelElement.textContent = "Room D722 Laboratory";
                        break;
                    case "11":
                        imageElement.src = "images/room723.png";
                        labelElement.textContent = "Room D723 Laboratory";
                        break;
                    case "12":
                        imageElement.src = "images/room724.png";
                        labelElement.textContent = "Room D724 Laboratory";
                        break;
                    case "13":
                        imageElement.src = "images/room725.png";
